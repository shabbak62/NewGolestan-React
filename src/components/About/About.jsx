...
const About = () => {
    ...
    <div className="w-full h-full px-4 sm:px-10 md:px-20 lg:px-[240px] py-8 sm:py-12 lg:py-[80px] bg-white grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 animate__animated animate__zoomIn animate__slow animate__delay-1s">
